...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final ImageButton registerButton = view.findViewById(R.id.toRegisterButton);
        ...
        loginViewModel.getUsernameText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loginViewModel.login(username,password,sharedViewModel);
            }
        });
